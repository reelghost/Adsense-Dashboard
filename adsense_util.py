...
def decode_base64_to_file(base64_string, output_path):
    """
    Function to decode base64 string to a file
    """
    with open(output_path, 'wb') as file:
        file.write(base64.b64decode(base64_string))

# Access secrets from Streamlit secrets
client_secrets_base64 = st.secrets.client_secrets_base64

# Decode and write the files
decode_base64_to_file(client_secrets_base64, 'client_secrets.json')
